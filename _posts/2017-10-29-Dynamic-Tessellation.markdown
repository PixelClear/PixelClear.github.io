...
![Tessellation]({{site.url}}/_posts/Images/Tess0.png){:class="img-responsive"}
...
![Tessellation Artifacts]({{site.url}}/_posts/Images/Tess1.png){:class="img-responsive"}

![Tessellation Artifacts]({{site.url}}/_posts/Images/Tess2.jpg){:class="img-responsive"}
